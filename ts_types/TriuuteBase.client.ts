...
import { Addr, ConfigResponse, Config, ExecuteMsg, Uint128, HistoricalTributeClaimsResponse, TributeClaim, Coin, InstantiateMsg, OutstandingTributeClaimsResponse, Timestamp, Uint64, ProposalTributesResponse, Tribute, QueryMsg, RoundTributesResponse } from "./TriuuteBase.types";
export interface TriuuteBaseReadOnlyInterface {
...
export class TriuuteBaseQueryClient implements TriuuteBaseReadOnlyInterface {
...
export interface TriuuteBaseInterface extends TriuuteBaseReadOnlyInterface {
  contractAddress: string;
  sender: string;
  addTribute: ({
    proposalId,
...
export class TriuuteBaseClient extends TriuuteBaseQueryClient implements TriuuteBaseInterface {
