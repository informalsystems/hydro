...
import {
  ...
  LockEntry,
  Coin,
  AllUserLockupsWithTrancheInfosResponse,
  ...
  SpecificUserLockupsWithTrancheInfosResponse,
...
export class HydroBaseQueryClient implements HydroBaseReadOnlyInterface {
  ...
  constructor(client: CosmWasmClient, contractAddress: string) {
    ...
    this.allUserLockupsWithTrancheInfos =
      this.allUserLockupsWithTrancheInfos.bind(this);
    this.specificUserLockupsWithTrancheInfos =
      this.specificUserLockupsWithTrancheInfos.bind(this);
    ...
    this.registeredValidatorQueries =
      this.registeredValidatorQueries.bind(this);
    this.validatorPowerRatio = this.validatorPowerRatio.bind(this);
    this.liquidityDeployment = this.liquidityDeployment.bind(this);
    this.roundTrancheLiquidityDeployments =
      this.roundTrancheLiquidityDeployments.bind(this);
  }
  ...
  registeredValidatorQueries =
    async (): Promise<RegisteredValidatorQueriesResponse> => {
      return this.client.queryContractSmart(this.contractAddress, {
