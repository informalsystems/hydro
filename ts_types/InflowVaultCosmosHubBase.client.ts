...
import { InstantiateMsg, DenomMetadata, ExecuteMsg, Uint128, AllocationMode, DeploymentTracking, UpdateConfigData, Coin, QueryMsg, Order, Addr, AdapterInfoResponse, AdapterInfo, ConfigResponse, Config, PoolInfoResponse, FundedWithdrawalRequestsResponse, AdaptersListResponse, Timestamp, Uint64, UserPayoutsHistoryResponse, PayoutEntry, UserWithdrawalRequestsResponse, WithdrawalEntry, WhitelistResponse, WithdrawalQueueInfoResponse, WithdrawalQueueInfo } from "./InflowVaultCosmosHubBase.types";
export interface InflowVaultCosmosHubBaseReadOnlyInterface {
...
export class InflowVaultCosmosHubBaseQueryClient implements InflowVaultCosmosHubBaseReadOnlyInterface {
...
export interface InflowVaultCosmosHubBaseInterface extends InflowVaultCosmosHubBaseReadOnlyInterface {
  contractAddress: string;
  sender: string;
  deposit: ({
    onBehalfOf
...
export class InflowVaultCosmosHubBaseClient extends InflowVaultCosmosHubBaseQueryClient implements InflowVaultCosmosHubBaseInterface {
