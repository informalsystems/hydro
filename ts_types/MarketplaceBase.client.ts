...
export interface MarketplaceBaseInterface extends MarketplaceBaseReadOnlyInterface {
  ...
  claimAdminRole: (fee_?: number | StdFee | "auto", memo_?: string, funds_?: Coin[]) => Promise<any>;
}
export class MarketplaceBaseClient extends MarketplaceBaseQueryClient implements MarketplaceBaseInterface {
  ...
  claimAdminRole = async (fee_: number | StdFee | "auto" = "auto", memo_?: string, funds_?: Coin[]): Promise<any> => {
    return await this.client.execute(this.sender, this.contractAddress, {
      claim_admin_role: {}
    }, fee_, memo_, funds_);
  };
