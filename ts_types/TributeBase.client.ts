...
import { InstantiateMsg, ExecuteMsg, QueryMsg, Addr, ConfigResponse, Config, Uint128, HistoricalTributeClaimsResponse, TributeData, Coin, OutstandingLockupClaimableCoinsResponse, OutstandingTributeClaimsResponse, Timestamp, Uint64, ProposalTributesResponse, Tribute, RoundTributesResponse, SpecificTributesResponse } from "./TributeBase.types";
export interface TributeBaseReadOnlyInterface {
  ...
  specificTributes: ({
    ...
    tributeIds: number[];
  }) => Promise<SpecificTributesResponse>;
}
export class TributeBaseQueryClient implements TributeBaseReadOnlyInterface {
  ...
  constructor(client: CosmWasmClient, contractAddress: string) {
    ...
    this.specificTributes = this.specificTributes.bind(this);
  }
