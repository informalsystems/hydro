...
/// Message for instantiating the Skip adapter contract on Cosmos Hub
#[cw_serde]
...
/// Simplified swap parameters — unified for cross-chain venues
#[cw_serde]
...
pub enum SkipAdapterMsg {
    ...
    /// Dispatches cross-chain IBC transfer with Skip wasm hook memo
