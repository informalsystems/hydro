...
pub fn mock_dependencies() -> OwnedDeps<MockStorage, MockApi, MockQuerier, TokenFactoryQuery> {
    OwnedDeps {
...
fn set_vault_shares_denom(
    deps: &mut OwnedDeps<MemoryStorage, MockApi, MockQuerier, TokenFactoryQuery>,
...
fn verify_withdrawal_queue_info(
    deps: &OwnedDeps<MemoryStorage, MockApi, MockQuerier, TokenFactoryQuery>,
