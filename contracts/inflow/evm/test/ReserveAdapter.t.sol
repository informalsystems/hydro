...
/// @notice Unit tests for ReserveAdapter. These assert the two behaviors that differ from
/// BasicInflowAdapter and are intentional here: a shared pool with no per-depositor accounting,
/// and a hardcoded zero position that keeps the adapter always disconnectable.
