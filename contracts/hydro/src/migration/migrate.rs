...
use crate::migration::v3_5_1::ConstantsV3_5_1;
...
pub fn migrate_constants(
    ...
    const OLD_CONSTANTS: Map<u64, ConstantsV3_5_1> = Map::new("constants");

    let old_constants_entries = OLD_CONSTANTS
        .range(deps.storage, None, None, Order::Ascending)
        .filter_map(|result| result.ok())
        .collect::<Vec<(u64, ConstantsV3_5_1)>>();
    ...
    for (timestamp, old_constants) in old_constants_entries {
        let new_constants = Constants {
            ...
            slash_percentage_threshold: migrate_msg.slash_percentage_threshold,
